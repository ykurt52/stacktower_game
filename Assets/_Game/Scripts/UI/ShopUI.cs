...
public class ShopUI : MonoBehaviour
{
    ...
    public void RefreshAll()
    {
        ...
        if (category == ShopManager.ItemCategory.Weapons && ScoreManager.Instance != null)
        {
            ...
            if (stoneDisplay != null)
                stoneDisplay.text = "Tas: " + ScoreManager.Instance.UpgradeStones;
        }
    ...
    private string GetIconSymbol(string id)
    {
        switch (id)
        {
            ...
            case "laserresist": return "X";
            case "bow": return ")>";
            case "scythe": return "J";
            case "sawblade": return "*";
            case "tornado": return "~";
            case "spear": return "|>";
            case "staff": return "T";
            case "hp": return "+";
            case "shieldupgrade": return "O";
            default: return "?";
        }
    }
